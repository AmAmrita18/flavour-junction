    ...
    <div className="w-full">
      <div className="w-[80%]  max-w-[1200px] pt-8 pb-8 lg:my-20 md:my-10 my-5 mx-auto">
        <div className="flex md:flex-row flex-col-reverse lg:gap-44 md:gap-8 gap-4">
          <div className="md:w-[50%] w-full md:px-0 px-4 lg:mt-12 md:mt-4 mt-0">
            <div className="flex gap-4 items-center ">
              <div className="w-3 h-3 bg-[#f6f7eb] "></div>
              <h4 className="text-xl font-[600] text-[#EF4030]">
              Flavor Junction's Exquisite Collection
              </h4>
            </div>
            ...
            <div className="flex flex-col gap-y-4">
              ...
              At Flavor Junction, we infuse traditional flavors with contemporary flair to offer you an unmatched culinary journey. Our seasoned artisans are constantly refining their skills to select the finest spices from across India. It's not just a transaction; it's an intimate exploration into the soul of Indian gastronomic tradition.
              </p>
              <p className="lg:text-[19px] md:text-[18px] text-[15px] font-[400] text-[#f6f7eb] leading-tight">
              ...
              <p className="lg:text-[19px] md:text-[18px] text-[15px] font-[400] text-[#f6f7eb] leading-tight">
              Indulge in the authentic flavors of India. Let Flavor Junction be your gateway to crafting unforgettable dishes and forging lasting memories, one flavor at a time.
              </p>
            </div>
          </div>
