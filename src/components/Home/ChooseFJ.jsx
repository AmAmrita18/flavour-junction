      ...
      <div className="w-[80%]  max-w-[1200px] pt-8 py-8 lg:my-20 md:my-14 my-5 mx-auto">
        <div className="flex flex-col items-center justify-center lg:mt-20 md:mt-4 mt-1">
          ...
          <div className="flex flex-col mt-6 gap-y-4">
            ...
            Though our renown may precede us, we believe the authentic Flavour Junction experience is best savored firsthand.

              <br />
              We extend a hearty invitation to explore our bustling stall at Varanasi's spice market. Here, you can connect with our passionate team, immerse yourself in the irresistible aromas of our spices, and grasp why our patrons are drawn back time and again.
            </p>
